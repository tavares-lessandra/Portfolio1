...
<head>
    ...
    <title>Portfolio lessandra</title>
    <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
    <link rel="stylesheet" href="css/main.css">
    <link href="https://fonts.googleapis.com/css?family=Dancing+Script|Kaushan+Script&display=swap" rel="stylesheet">
</head>
...
<header>
    ...
    <div class="landing-text">
            <h1>Hello <br/>Je suis Lessandra Tavares</h1>
...
<section class="about" id="about">
    <div class="container">
        ...
        <div class="about-details" data-aos="fade-left" data-aos-delay="600">
            ...
            <p class="text1">
                Je suis Developpeuse, freelance depuis 2020. 
                Je conçois et réalise des sites web du cahier des charges à la mise en ligne,
                 en passant par la conception graphique, la prise de vue photographique et le développement.
                 J’interviens seul ou en équipe. Mes partenaires sont des photographes, rédacteurs, stylistes, et imprimeurs.
                Mes clients sont des sociétés, des consultants des artisans et des artistes.
                Je travaille également en partenariat avec des agences web et événementielles.
<br/>
<br>
                    J’aime les gens passionnés et engagés dans leurs talents. J’aime travailler avec eux et les accompagner dans leurs projets.
            </p>
